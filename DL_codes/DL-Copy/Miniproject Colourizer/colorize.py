...
# To run code:
# python colorize.py --image | -i C:\Users\anime\Downloads\DL_codes\DL-Copy\Miniproject Colourizer\images
# Example: python colorize.py -i C:\Users\anime\Downloads\DL_codes\DL-Copy\Miniproject Colourizer\images
